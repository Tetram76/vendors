...
{ Modified by F. GUILLIEN 07/2005 }
...
function CompareVersion(Version1, Version2 : TLongVersion) : Integer;
...
{ F. GUILLIEN Compare two versions }

function CompareVersion(Version1, Version2 : TLongVersion) : Integer;
begin
  if Version1.MS < Version2.MS then
    Result := -1
  else
  if Version1.MS > Version2.MS then
    Result := 1
  ...
  begin
    if Version1.LS < Version2.LS then
      Result := -1
    else
    if Version1.LS > Version2.LS then
      Result := 1
