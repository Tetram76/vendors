...
type
  ...
  TProgressGaugeKind = (gkText, gkHorizontalBar, gkVerticalBar, gkPie, gkNeedle);

  TProgressGauge = class(TGraphicControl)
  private
    FMinValue: Longint;
    FMaxValue: Longint;
    FCurValue: Longint;
    FKind: TProgressGaugeKind;
    FShowText: Boolean;
    ...
    procedure SeTProgressGaugeKind(Value: TProgressGaugeKind);
  ...
  published
    ...
    property Color;
    property Enabled;
    property Kind: TProgressGaugeKind read FKind write SeTProgressGaugeKind default gkHorizontalBar;
...
constructor TProgressGauge.Create(AOwner: TComponent);
begin
...
function TProgressGauge.GetPercentDone: Longint;
begin
  Result := SolveForY(FCurValue - FMinValue, FMaxValue - FMinValue);
end;

procedure TProgressGauge.Paint;
var
  TheImage: TBitmap;
...
procedure TProgressGauge.PaintBackground(AnImage: TBitmap);
var
  ARect: TRect;
begin
...
procedure TProgressGauge.PaintAsText(AnImage: TBitmap; PaintRect: TRect);
var
  S: string;
  X, Y: Integer;
  OverRect: TBltBitmap;
...
procedure TProgressGauge.PaintAsNothing(AnImage: TBitmap; PaintRect: TRect);
begin
  with AnImage do
  begin
...
procedure TProgressGauge.PaintAsBar(AnImage: TBitmap; PaintRect: TRect);
var
  FillSize: Longint;
  W, H: Integer;
begin
...
procedure TProgressGauge.PaintAsPie(AnImage: TBitmap; PaintRect: TRect);
var
...
procedure TProgressGauge.PaintAsNeedle(AnImage: TBitmap; PaintRect: TRect);
var
  MiddleX: Integer;
  Angle: Double;
  X, Y, W, H: Integer;
...
procedure TProgressGauge.SeTProgressGaugeKind(Value: TProgressGaugeKind);
begin
  if Value <> FKind then
  begin
    FKind := Value;
...
procedure TProgressGauge.SetShowText(Value: Boolean);
begin
...
procedure TProgressGauge.SetBorderStyle(Value: TBorderStyle);
begin
...
procedure TProgressGauge.SetForeColor(Value: TColor);
begin
...
procedure TProgressGauge.SetBackColor(Value: TColor);
begin
...
procedure TProgressGauge.SetMinValue(Value: Longint);
begin
...
procedure TProgressGauge.SetMaxValue(Value: Longint);
begin
  if Value <> FMaxValue then
  begin
    if Value < FMinValue then
...
procedure TProgressGauge.SetProgress(Value: Longint);
var
  TempPercent: Longint;
begin
...
procedure TProgressGauge.AddProgress(Value: Longint);
begin
